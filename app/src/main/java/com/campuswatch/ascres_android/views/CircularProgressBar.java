...
public class CircularProgressBar extends android.support.v7.widget.AppCompatImageView {

    private static final ScaleType SCALE_TYPE = ScaleType.CENTER_CROP;

    private static final Bitmap.Config BITMAP_CONFIG = Bitmap.Config.ARGB_8888;
    private static final int COLOR_DRAWABLE_DIMENSION = 2;
    private static float DEFAULT_INNER_DIAMETER_FRACTION = 0.805f;
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircularProgressBar_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircularProgressBar_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircularProgressBar_border_overlay, DEFAULT_BORDER_OVERLAY);
        mFillColor = a.getColor(R.styleable.CircularProgressBar_fill_color, DEFAULT_FILL_COLOR);
        mInnerCircleDiameter = a.getFloat(R.styleable.CircularProgressBar_center_circle_diameter, DEFAULT_INNER_DIAMETER_FRACTION);
        mProgressColor = a.getColor(R.styleable.CircularProgressBar_progress_color, DEFAULT_PROGRESS_COLOR);
        mBaseStartAngle = a.getFloat(R.styleable.CircularProgressBar_progress_startAngle, 0);
    ...
    public void setValue(float newValue, boolean animated) {
        ...
        long newDuration = animated ? DEFAULT_ANIMATION_TIME : 0;
        mValueAnimator.setDuration(newDuration);
    ...
    private void setup() {
        ...
        if (mInnerCircleDiameter > 1) mInnerCircleDiameter = 1;

        mDrawableRadius = mDrawableRadius * mInnerCircleDiameter;
